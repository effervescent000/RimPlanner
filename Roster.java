...
public class Roster {
    ...
    /**
     * Ensures that all skill fields are added to the HashMap without creating
     * duplicates.
     *
     * @param hm The HashMap generated by findVulnerable();
     * @param s The skill name to use as the key.
    ...
    /**
     * Looks for Pawns who make up a disproportionate amount of any given skill, and adds them to the key for said skill.
     * 
     * @param hm The HashMap generated by findVulnerable().
     * @param s The skill in question.
     * @return The modified HashMap.
     */
    private HashMap<String, ArrayList<Pawn>> checkSkill(HashMap<String, ArrayList<Pawn>> hm, String s) {
        double bp;
        double c = roster.size();
